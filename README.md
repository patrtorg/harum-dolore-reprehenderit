...
<p align="center"><a href="https://github.com/patrtorg/harum-dolore-reprehenderit/tree/master/docs"><strong>Docs: Getting Started →</strong></a></p>
<p align="center"><a href="https://libauth.org/#md:api-overview">API Reference</a></p>

<p align="center">
  <a href="https://www.npmjs.com/package/@patrtorg/harum-dolore-reprehenderit"><img src="https://img.shields.io/npm/v/@patrtorg/harum-dolore-reprehenderit.svg" alt="NPM version" /></a>
  <a href="https://codecov.io/gh/patrtorg/harum-dolore-reprehenderit"><img src="https://img.shields.io/codecov/c/github/patrtorg/harum-dolore-reprehenderit/master.svg" alt="Codecov" /></a>
  <a href="https://github.com/patrtorg/harum-dolore-reprehenderit/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/patrtorg/harum-dolore-reprehenderit/ci.yml?branch=master" alt="CI" /></a>
  ...
  <a href="https://www.npmjs.com/package/@patrtorg/harum-dolore-reprehenderit"><img alt="npm downloads" src="https://img.shields.io/npm/dm/@patrtorg/harum-dolore-reprehenderit"></a>
  <a href="https://github.com/patrtorg/harum-dolore-reprehenderit"><img src="https://img.shields.io/github/stars/patrtorg/harum-dolore-reprehenderit.svg?style=social&logo=github&label=Stars" alt="GitHub stars" /></a>
</p>
...
To get started, install `@patrtorg/harum-dolore-reprehenderit`:

```sh
npm install @patrtorg/harum-dolore-reprehenderit
# OR
yarn add @patrtorg/harum-dolore-reprehenderit
```

And import the functionality you need:

```ts
import { secp256k1 } from '@patrtorg/harum-dolore-reprehenderit';
...
- [Installation](https://github.com/patrtorg/harum-dolore-reprehenderit/blob/master/docs/install.md)
- [Handling Errors](https://github.com/patrtorg/harum-dolore-reprehenderit/blob/master/docs/errors.md)
- [Cryptography](https://github.com/patrtorg/harum-dolore-reprehenderit/blob/master/docs/crypto.md)
- [Keys](https://github.com/patrtorg/harum-dolore-reprehenderit/blob/master/docs/keys.md)
- [Addresses](https://github.com/patrtorg/harum-dolore-reprehenderit/blob/master/docs/addresses.md)
- [Verifying Transactions](https://github.com/patrtorg/harum-dolore-reprehenderit/blob/master/docs/verify-transactions.md)
- [Wallets & Transaction Creation](https://github.com/patrtorg/harum-dolore-reprehenderit/blob/master/docs/wallets.md)
...
For example, utilities related to hexadecimal-encoded strings are defined in [`hex.ts`](https://github.com/patrtorg/harum-dolore-reprehenderit/blob/master/src/lib/format/hex.ts); for thorough usage examples, see the co-located [`hex.spec.ts`](https://github.com/patrtorg/harum-dolore-reprehenderit/blob/master/src/lib/format/hex.spec.ts). You can also use GitHub search to see how a particular utility is used throughout the library, e.g. [`splitEvery`](https://github.com/search?q=repo%3Abitauth%2Flibauth+splitEvery&type=code).
...
Libauth's test suite includes a set of cross-implementation Virtual Machine Bytecode (VMB) test vectors for each supported VM. See [`Libauth VMB Tests`](https://github.com/patrtorg/harum-dolore-reprehenderit/blob/master/src/lib/vmb-tests/readme.md) for details.
...
Pull Requests welcome! Please see [`CONTRIBUTING.md`](https://github.com/patrtorg/harum-dolore-reprehenderit/blob/master/.github/CONTRIBUTING.md) for details.
